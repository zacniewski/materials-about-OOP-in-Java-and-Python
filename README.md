...
1. Paradygmaty obiektowości — zobacz: [01-paradygmaty-obiektowości.md](OOP-main-lectures-in-Java/01-paradygmaty-obiektowości.md), podstawy składni obu języków.  
...
3. Klasy oraz ich elementy składowe, metody klasy — zobacz: [03-klasy-i-metody.md](OOP-Python-lectures-and-slides/03-klasy-i-metody-podsumowanie-programistyczne.md)  
